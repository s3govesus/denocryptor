...
function sha512Encoded(str: string, enc: string) {
...
function hmacSHA512Hex(key: any, data: any) {
...
function hmacSHA512B64(key: any, data: any) {
  return stringToBase64(
    stringToHMACSHA512(stringToUTF8(key), stringToUTF8(data)),
  );
}
...
function hmacSHA512Encoded(key: any, data: any, e: any) {
  return stringToEncoded(
    stringToHMACSHA512(stringToUTF8(key), stringToUTF8(data)),
    e,
  );
}
...
function stringToSHA512(str: string) {
  return bigEndiansToString(
    bigEndiansToSHA512(stringToBigEndians(str), str.length * 8),
  );
}
...
function stringToHMACSHA512(key: any, data: any) {
...
function stringToHex(input: any) {
...
function stringToBase64(input: any) {
  if (b64pad === undefined) {
    b64pad = ``;
  }
...
function stringToEncoded(input: any, encoding: any) {
...
function stringToUTF8(input: any) {
  let output = ``;
  let i = -1;
  let x;
  let y;
...
function stringToUTF16Little(input: any) {
  let output = ``;
  const inputLength = input.length;
  for (let i = 0; i < inputLength; i++) {
    output += String.fromCharCode(
...
function stringToUTF16Big(input: any) {
  let output = ``;
  const inputLength = input.length;
  for (let i = 0; i < inputLength; i++) {
    output += String.fromCharCode(
...
function stringToBigEndians(input: any) {
  const inputLength = input.length;
...
function bigEndiansToString(input: any) {
  let output = ``;
  const inputLength = input.length;
...
let sha512K: any;
function bigEndiansToSHA512(x: any, len: any) {
...
function int64copy(dst: any, src: any) {
  dst.h = src.h;
  dst.l = src.l;
}
...
function int64rrot(dst: any, x: any, shift: any) {
...
function int64revrrot(dst: any, x: any, shift: any) {
...
function int64shr(dst: any, x: any, shift: any) {
  dst.l = (x.l >>> shift) | (x.h << (32 - shift));
  dst.h = x.h >>> shift;
}
...
function int64add(dst: any, x: any, y: any) {
...
function int64add4(dst: any, a: any, b: any, c: any, d: any) {
...
function int64add5(dst: any, a: any, b: any, c: any, d: any, e: any) {
  const w0 = (a.l & 0xffff) +
    (b.l & 0xffff) +
    (c.l & 0xffff) +
    (d.l & 0xffff) +
